package gov.samhsa.pls.web.controller.instrumentation;
...
public class LoggerCheckController {
    ...
    /**
     * Test whether the Provider logging works or not.
     *
     * @param key the key
     * @return the string
     */
    ...
    public
    @ResponseBody
    String check(@RequestParam(value = "instrumentationKey") String key) {
