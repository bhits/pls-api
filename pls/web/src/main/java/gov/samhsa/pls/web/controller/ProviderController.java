package gov.samhsa.pls.web.controller;
...
import gov.samhsa.pls.service.ProviderService;
import gov.samhsa.pls.service.dto.ProviderDto;
import gov.samhsa.pls.service.dto.ProvidersDto;
import gov.samhsa.pls.web.util.URLArgument;
import gov.samhsa.pls.web.util.URLArgument.URLHelper;
/**
...
public class ProviderController {
	...
	@ResponseStatus(HttpStatus.OK)
	public @ResponseBody
	ProvidersDto findbyCityAndState(
			@PathVariable("pageNumber") String pageNumber,
		...
		return new ProvidersDto(
				providerService
						.getByGenderCodeAndUSStateAbbreviationAndCityAndSpecialityAndTelephoneNumberAndLastNameAndFirstNameAndEntityTypeAndProviderOrganizationName(
								ProviderService.SEARCH_STRING, usStateAbbreviation, city,
								ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING,
								ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING,
								pageNumber));
	}
		...
		return new ProvidersDto(
				providerService
						.getByGenderCodeAndPostalCodeAndSpecialityAndTelephoneNumberAndLastNameAndFirstNameAndEntityTypeAndProviderOrganizationName(
								ProviderService.SEARCH_STRING, postalCode, ProviderService.SEARCH_STRING,
								ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING,
								ProviderService.SEARCH_STRING, ProviderService.SEARCH_STRING, pageNumber));
	}
	...
	private Map<String, Object> executeProvidersMethod(String methodType,
		...
		if (URLArgument.URLHelper.CITY_STATE_METHOD_TYPE.equals(methodType)) {
