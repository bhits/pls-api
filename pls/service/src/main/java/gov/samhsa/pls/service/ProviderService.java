...
/**
	 * Get a single {@link gov.samhsa.pls.ProviderDtobased on National Provider Id
	 * @param npi unique National Provider Id
	 * @return {@link gov.samhsa.pls.ProviderDto	 */
	public ProviderDto getProvider(String npi);

/**
	 * Retrieve {@link gov.samhsa.pls.ProviderDtousing the
	 ...
	 *         {@link gov.samhsa.pls.domain.service.dto.fcom.feisystems.provider.ProviderDto
	 */
